...
from src.accordo_workflow_mcp.utils.workflow_engine import (
    WorkflowEngine,
    WorkflowEngineError,
)
...
class TestWorkflowEngine:
    ...
    def engine(self):
        ...
        with patch("src.accordo_workflow_mcp.utils.workflow_engine.WorkflowLoader"):
    ...
    def test_initialize_workflow_with_workflow_name(self, engine, mock_workflow_def):
        ...
        with patch(
            "src.accordo_workflow_mcp.utils.workflow_engine.DynamicWorkflowState"
        ) as mock_state_class:
