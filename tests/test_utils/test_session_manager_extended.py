...
class TestSessionManagerClientRegistry:
    ...
    def test_register_session_for_client(self, test_workflow_def):
        ...
        assert session.session_id in session_manager.client_session_registry["test-client"]
    ...
    def test_unregister_session_for_client(self, test_workflow_def):
        ...
        # Manually unregister
        session_manager._unregister_session_for_client("test-client", session.session_id)
        
        # Should be removed from registry
        if "test-client" in session_manager.client_session_registry:
            assert session.session_id not in session_manager.client_session_registry["test-client"]
...
class TestSessionManagerDynamicInputs:
    ...
    def test_prepare_dynamic_inputs_basic(self, test_workflow_def):
        ...
        test_workflow_def.inputs = {
            "task_description": WorkflowInput(type="string", description="Task to perform"),
            "priority": WorkflowInput(type="string", description="Task priority", default="medium")
        }
    ...
    def test_prepare_dynamic_inputs_type_defaults(self, test_workflow_def):
        ...
        test_workflow_def.inputs = {
            "task_description": WorkflowInput(type="string", description="Task to perform", required=True),
            "count": WorkflowInput(type="number", description="Number of items", required=True),
            "enabled": WorkflowInput(type="boolean", description="Enable feature", required=True),
            "name": WorkflowInput(type="string", description="Name", required=True),
            "config": WorkflowInput(type="object", description="Configuration object", required=True)
        }
...
class TestSessionManagerUtilityFunctions:
    ...
    def test_add_log_to_session_success(self, test_workflow_def):
        ...
        result = session_manager.add_log_to_session(session.session_id, "Test log entry")
    ...
    def test_add_item_to_session_success(self, test_workflow_def):
        ...
        result = session_manager.add_item_to_session(session.session_id, "New task item")
...
class TestSessionManagerWorkflowDefinitionCache:
    ...
    def test_store_workflow_definition_in_cache(self, test_workflow_def):
        ...
        session_manager.store_workflow_definition_in_cache(session_id, test_workflow_def)
        
        assert session_id in session_manager.workflow_definitions_cache
        assert session_manager.workflow_definitions_cache[session_id] == test_workflow_def
    ...
    def test_get_workflow_definition_from_cache_not_exists(self):
        ...
        retrieved_def = session_manager.get_workflow_definition_from_cache("nonexistent")
    ...
    def test_get_dynamic_session_workflow_def(self, test_workflow_def):
        ...
        # Store in cache
        session_manager.store_workflow_definition_in_cache(session.session_id, test_workflow_def)
        
        retrieved_def = session_manager.get_dynamic_session_workflow_def(session.session_id)
...
class TestSessionManagerConflictDetection:
    ...
    def test_detect_session_conflict_no_conflict(self, test_workflow_def):
        ...
        session_manager.create_dynamic_session("test-client", "Task 1", test_workflow_def)
...
class TestSessionManagerSummaryAndCleanup:
    ...
    def test_clear_all_client_sessions(self, test_workflow_def):
        ...
        assert session_manager.get_session(session3.session_id) is not None  # Other client's session should remain 