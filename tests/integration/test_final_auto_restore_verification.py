...
def test_final_auto_restore_verification():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        cache_dir = temp_path / ".workflow-commander" / "cache"
        ...
        try:
            ...
            from dev_workflow_mcp.services.dependency_injection import register_singleton, clear_registry
            ...
            from dev_workflow_mcp.services import get_session_sync_service, get_session_repository
            ...
            print(f"✅ In-memory sessions cleared: {len(all_sessions)} sessions remaining")
            ...
            for original_session in test_sessions:
                ...
                if restored_session:
                    print(f"✅ Session {original_session.session_id} successfully restored")
            ...
            if restored_count == len(test_sessions):
                ...
                print(f"⚠️  PARTIAL SUCCESS: {restored_count}/{len(test_sessions)} sessions restored")
            else:
                print(f"❌ FAILURE: No sessions restored (expected {len(test_sessions)})")
