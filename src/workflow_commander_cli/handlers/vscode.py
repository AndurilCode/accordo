...
class VSCodeHandler(BaseConfigHandler):
    ...
    def add_server(self, name: str, server: MCPServer, config_path: Path | None = None, 
    ...
    def remove_server(self, name: str, config_path: Path | None = None,
                      use_global: bool = True) -> bool:
        ...
        if (existing_config is None or 
            "mcp" not in existing_config or 
            "servers" not in existing_config["mcp"]):
    ...
    def merge_with_existing_settings(self, mcp_config: dict[str, Any], 
