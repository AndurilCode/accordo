...
class ConfigLocation(BaseModel):
    ...
    project_path: Path | None = Field(default=None, description="Project-specific configuration path")
    description: str = Field(..., description="Human-readable description of the location")
...
class PlatformInfo(BaseModel):
    ...
    config_format: str = Field(..., description="Configuration format (e.g., 'mcpServers' or 'mcp.servers')")
    locations: ConfigLocation = Field(..., description="Configuration file locations")
    supported_transports: list[str] = Field(default_factory=list, description="Supported MCP transport types")
    documentation_url: str | None = Field(default=None, description="Link to platform documentation")
